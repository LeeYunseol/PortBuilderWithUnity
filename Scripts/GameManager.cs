...
public class GameManager : MonoBehaviour
{
    ...
    public UpdateDictionary updateDictionary;
    ...
    void Start()
    {
        ...
        uiController.OnDeleteRoad += DeleteHandler;
    ...
    private void DeleteHandler()
    {
        ...
        inputManager.OnMouseClick += (pos) =>
        {
            ProcessInputAndCall(deleteManager.DeleteRoad, pos);
        };
        inputManager.OnMouseUp += deleteManager.FixRoadAfterDelete;
        inputManager.OnEscape += HandleEscape;
    }
